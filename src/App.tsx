    ...
    <div className="min-h-screen flex flex-col bg-[#fdfbfa] text-[#2e1e1c]">
      ...
      <main className="flex-1">
        ...
        {currentPage === "catalogo" &&
          (activeCategory ? (
            <Categoria category={activeCategory} onBack={goBack} />
          ) : (
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25d366] text-white rounded-full size-14 flex items-center justify-center shadow-lg hover:scale-105 transition-transform"
      >
